...
export const fetchNotificationsTool = (tkn: string, filters: FilterRule[], since: string) =>
    createTool({
...
export const getPRDetailsTool = (tkn: string) =>
    createTool({
...
export const getPRReviewsTool = (tkn: string) =>
    createTool({
...
export const getIssueDetailsTool = (tkn: string) =>
    createTool({
